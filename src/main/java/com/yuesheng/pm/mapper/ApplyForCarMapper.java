...
@Mapper
public interface ApplyForCarMapper {
     ...
     * @return
     */
    List<ApplyForCar> selectByParam(Map<String, Object> params);
     ...
     * @return
     */
    List<StatisticByProject> selectByGroup();
     ...
     * @return
     */
    List<StatisticByDriver> selectByDate(@Param("startDate")String startDate, @Param("endDate")String endDate);
     ...
     * @return
     */
    boolean setDriver(@Param("driverName")String driverName,@Param("driverId")String driverId,@Param("id")Integer id);

    /**
     * 获取司机待出勤列表
     * @return
     */
    List<ApplyForCar> getDriverTask(String driverId);
     ...
     * @return
     */
    List<ApplyForCar> getDriverTaskDone(String driverId);
